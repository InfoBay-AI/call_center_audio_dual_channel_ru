...
This dataset is a **large-scale collection of raw Russian call center audio (dual-channel)**, designed to support the development and training of advanced speech and AI systems.
